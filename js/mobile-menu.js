document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".q-a-navigation-list");
  const headerRef = document.querySelector(".q-a-header");
  const navigationRef = document.querySelector(".q-a-navigation");
